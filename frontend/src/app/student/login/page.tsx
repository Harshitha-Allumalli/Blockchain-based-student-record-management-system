...
import { GraduationCap, Eye, EyeOff, ArrowLeft, Loader2, Mail, Lock, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 text-slate-900">
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
        ...
        {/* Left Graphic Side */}
        <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 p-10 text-white flex flex-col justify-between relative overflow-hidden">
          <div className="z-10">
          ...
          <div className="my-12 flex flex-col items-center text-center z-10">
            ...
            <p className="text-sm text-blue-100/80 max-w-xs">Access &amp; share your verified academic degrees, transcripts and certificates</p>
          </div>
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            >
              {loading ? <><Loader2 size={18} className="animate-spin" /> Signing In...</> : "Sign In to Student Dashboard"}
            </button>
          </form>

          <div className="mt-8 pt-6 border-t border-slate-200 text-center space-y-2">
            <Link href="/student/register" className="block text-xs font-semibold text-blue-600 hover:underline">
              Don&apos;t have an account? Register here →
            </Link>
            <Link href="/admin" className="block text-xs font-medium text-slate-500 hover:text-slate-700">
